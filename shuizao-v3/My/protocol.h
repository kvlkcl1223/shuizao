...
typedef enum {
    ...
    PROTOCOL_CMD_GET_SPEED,
    PROTOCOL_CMD_GET_MANUAL_SPEED,
    PROTOCOL_CMD_SAVE_SPRAY_MS,
    PROTOCOL_CMD_SAVE_ZVIRT_MS,
    PROTOCOL_CMD_SAVE_SPEED,
    PROTOCOL_CMD_SAVE_MANUAL_SPEED,
...
typedef enum {
    ...
    PROTOCOL_PARAM_SPRAY1_MS,
    PROTOCOL_PARAM_SPRAY2_MS,
