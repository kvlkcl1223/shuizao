...
/*
 * 分阶段吸取表：
 * - 800ml 到 300ml 是虚拟吸取段，移动时不开泵，到位停留时开泵吸取。
...
const App_AspirateStage APP_ASPIRATE_STAGES[] = {
    ...
    {700U, APP_Z_POS_700ML, APP_ASP_DWELL_700_MS, 0U, 1U},
    {600U, APP_Z_POS_600ML, APP_ASP_DWELL_600_MS, 0U, 1U},
    {500U, APP_Z_POS_500ML, APP_ASP_DWELL_500_MS, 0U, 1U},
    {400U, APP_Z_POS_400ML, APP_ASP_DWELL_400_MS, 0U, 1U},
    {300U, APP_Z_POS_300ML, APP_ASP_DWELL_300_MS, 0U, 1U},
