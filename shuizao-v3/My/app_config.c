...
/* 漏水检测输入。高电平为正常，低电平为异常；不要放入 APP_Z_ORDER。 */
...
const uint32_t APP_SPRAY_STAGE2_PUMP_MS[APP_SPRAY_PROFILE_COUNT][APP_PUMP_COUNT] = {
    {1000U, 1000U, 1000U, 1000U, 1000U, 1000U}, /* 200ml */
    {1000U, 1000U, 1000U, 1000U, 1000U, 1000U}, /* 150ml */
    {1000U, 1000U, 1000U, 1000U, 1000U, 1000U}, /* 100ml */
    {1000U, 1000U, 1000U, 1000U, 1000U, 1000U}, /* 50ml */
};
...
const uint32_t APP_SPRAY_STAGE3_PUMP_MS[APP_SPRAY_PROFILE_COUNT][APP_PUMP_COUNT] = {
    {800U, 800U, 800U, 800U, 800U, 800U}, /* 200ml */
    {800U, 800U, 800U, 800U, 800U, 800U}, /* 150ml */
    {800U, 800U, 800U, 800U, 800U, 800U}, /* 100ml */
    {800U, 800U, 800U, 800U, 800U, 800U}, /* 50ml */
};
