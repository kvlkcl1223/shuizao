...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = PG1_Pin|PG2_Pin|KEY2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pins : KEY1_Pin PG5_Pin PG6_Pin PG7_Pin
                           PG8_Pin */
  GPIO_InitStruct.Pin = KEY1_Pin|PG5_Pin|PG6_Pin|PG7_Pin
                          |PG8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : PG14_Pin */
  GPIO_InitStruct.Pin = PG14_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(PG14_GPIO_Port, &GPIO_InitStruct);
